...
import { applySlippage, buildRebalanceExecution, encodeRedeemDelegations, estimateGasAndFees, sendUserOperation } from '@/lib/agent/userop';
...
export async function GET() {
  try {
    ...
    const redeemCall = encodeRedeemDelegations(signedDelegation as Delegation, execution);
