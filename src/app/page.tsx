...
const features = [
  {
    ...
    description:
      "Advanced keeper service continuously monitors APYs across Kintsu and Magma protocols, executing intelligent rebalancing strategies.",
    gradient: "#f59e0b",
    color3d: "#f59e0b",
  ...
  },
  {
    ...
    description:
      "MetaMask Delegation Toolkit enables scoped permissions without exposing private keys, ensuring complete asset control.",
    gradient: "#0ea5e9",
    color3d: "#0ea5e9",
    imageUrl: "/shield.png",
  },
  {
    ...
    description:
      "Smart Account infrastructure enables transaction batching, gas optimization, and seamless automation via Pimlico.",
    gradient: "#14b8a6",
    color3d: "#14b8a6",
  ...
  },
  {
    ...
    description:
      "Envio Indexer provides comprehensive on-chain activity tracking and portfolio insights across all protocols.",
    gradient: "#ec4899",
    color3d: "#ec4899",
  ...
  },
  {
    ...
    title: "Monad Native",
    description:
      "Purpose-built to leverage Monad network performance, scalability, and emerging ecosystem opportunities.",
    gradient: "#6366f1",
    color3d: "#6366f1",
    imageUrl: "/images/feature-monad.png",
  },
    ...
    <div className="relative min-h-screen w-full overflow-x-hidden bg-[#05070D] text-white">
      ...
      <div className="relative z-10">
        ...
        <section className="relative px-4 pt-32 pb-24 md:pt-40 md:pb-32 lg:pt-48 lg:pb-40">
          ...
          <div className="mx-auto max-w-6xl">
            <div className="text-center">
              ...
              >
                Synapse Yield leverages Account Abstraction and MetaMask Delegation to automate yield strategies across
                Kintsu and Magma with institutional-grade security.
              </motion.p>
          ...
          <div className="mx-auto max-w-4xl text-center">
            <motion.div {...fadeInUp}>
              ...
              <p className="mb-16 text-lg leading-relaxed text-gray-400">
                Manual yield optimization requires constant monitoring, gas-intensive transactions, and expert knowledge
                of multiple protocols—resulting in missed opportunities and reduced returns.
              </p>
            </motion.div>
            ...
            <motion.div {...fadeInUp} transition={{ delay: 0.1, ...fadeInUp.transition }}>
              ...
              <h2 className="mb-6 text-3xl font-bold text-white sm:text-4xl lg:text-5xl">Intelligent Automation</h2>
              <p className="text-lg leading-relaxed text-gray-400">
                Synapse Yield automates yield optimization using Account Abstraction and secure MetaMask Delegation,
                maximizing returns while maintaining complete asset control.
              </p>
            </motion.div>
          </div>
        </section>
        ...
        <section className="px-4 py-20 md:py-28">
          <div className="mx-auto max-w-7xl">
            <motion.div {...fadeInUp} className="mb-16 text-center">
              <h2 className="mb-4 text-3xl font-bold text-white sm:text-4xl lg:text-5xl">Platform Capabilities</h2>
              ...
              {features.map((feature, index) => (
                ...
                >
                  ...
                  <div className="relative h-32 w-full overflow-hidden">
                    <Canvas className="h-full w-full" gl={{ alpha: true, antialias: true }} dpr={[1, 1.5]}>
                      <Suspense fallback={null}>
        ...
        <section className="px-4 py-20 md:py-28">
          <div className="mx-auto max-w-6xl">
            <motion.div {...fadeInUp} className="mb-16 text-center">
              <h2 className="mb-4 text-3xl font-bold text-white sm:text-4xl lg:text-5xl">How It Works</h2>
              <p className="mx-auto max-w-2xl text-lg text-gray-400">
                Get started with automated yield optimization in three steps
              </p>
            </motion.div>

            <motion.div variants={staggerContainer} initial="initial" whileInView="whileInView" className="relative">
        ...
        <section className="relative px-4 py-20 md:py-28">
          ...
          <div className="mx-auto max-w-7xl">
            <motion.div {...fadeInUp} className="mb-16 text-center">
              <h2 className="mb-4 text-3xl font-bold text-white sm:text-4xl lg:text-5xl">Technology Stack</h2>
              <p className="mx-auto max-w-2xl text-lg text-gray-400">Built on cutting-edge blockchain infrastructure</p>
            </motion.div>
                ...
                <table className="w-full">
                  ...
                  <tbody>
                    {comparisonData.map((row, index) => (
                      <tr key={index} className="border-b border-white/5 transition-colors hover:bg-white/[0.02]">
        ...
        <section className="px-4 py-24 md:py-32">
          <div className="mx-auto max-w-4xl text-center">
            <motion.div {...fadeInUp}>
              ...
              <p className="mb-10 text-lg text-gray-400">Experience automated DeFi yield generation on Monad Testnet</p>
              <Link
                href="/dashboard"
