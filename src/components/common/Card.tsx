    ...
    >
      ...
      <div
        className="absolute -inset-1 rounded-2xl bg-gradient-to-r 
                   from-cyan-500/80 via-blue-500/80 to-purple-500/80 
                   opacity-0 group-hover:opacity-30 transition-opacity 
                   duration-300 blur-lg"
        aria-hidden="true"
      />

      <Component
        className={`relative w-full h-full bg-slate-900/70 backdrop-blur-xl 
      ...
      >
        ...
        <div
          ...
          style={{ boxShadow: 'inset 0 0 15px rgba(0, 180, 219, 0.08)' }}
          aria-hidden="true"
        />
